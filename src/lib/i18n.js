...
const translations = {
  no: {
    ...
    back: 'Tilbake',
    start: 'Start',
    restartSeries: 'Restart serie',
    nextSeries: 'Neste serie',
    nextExerciseLabel: 'Neste øvelse',
    nextStageLabel: 'Neste delserie',
    upNext: 'Neste',
    current: 'Nåværende',
    metaLoading: 'lading',
    metaHidden: 'skjult',
    metaVisible: 'synlig',
    metaPerSeries: 'serie',
    metaShotsPerShowing: 'skudd/visning',
    pause: 'Pause',
    resume: 'Fortsett',
    stop: 'Stopp',
    reset: 'Nullstill',
  ...
  en: {
    ...
    metaHidden: 'hidden',
    metaVisible: 'visible',
    metaPerSeries: 'series',
    metaShotsPerShowing: 'shots/showing',
    pause: 'Pause',
    resume: 'Resume',
    stop: 'Stop',
    reset: 'Reset',
